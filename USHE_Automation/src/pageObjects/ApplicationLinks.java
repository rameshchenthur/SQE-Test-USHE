...
public class ApplicationLinks {
    ...
    public static WebElement link_Menu(WebDriver driver) {
	...
	public static WebElement link_AddTermForGenre(WebDriver driver){
		...
		element=driver.findElement(By.xpath(".//*[@id='edit-2-add']"));
    ...
    public static WebElement link_listofGenre(WebDriver driver){
		...
		element=driver.findElement(By.xpath(".//*[@id='edit-2-list']"));
    ...
    public static WebElement link_Queues(WebDriver driver) {
	     
  	  element = driver.findElement(By.linkText("Queues"));
  	   
  	  Log.info("Queues link found");
